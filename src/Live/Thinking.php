...
final class Thinking
{
    ...
    public const string SUBJECT_KEY = 'thinking';
    ...
    {
        return RenderEvents::of(self::class, self::BEFORE_RENDER, self::AFTER_RENDER, self::SUBJECT_KEY, 'the thinking prototype');
    }
