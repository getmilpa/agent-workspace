...
final class AgentMessage
{
    ...
    public const string SUBJECT_KEY = 'agentMessage';
    ...
    {
        return RenderEvents::of(self::class, self::BEFORE_RENDER, self::AFTER_RENDER, self::SUBJECT_KEY, 'the agent-message prototype');
    }
