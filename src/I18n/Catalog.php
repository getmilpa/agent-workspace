...
final class Catalog
{
    ...
    private const MESSAGES = [
        'en' => [
            ...
            'evidence.criteria' => 'Recorded delivery criteria',
            'evidence.set_criteria' => 'Set delivery criteria',
            'evidence.criteria_help' => 'Choose the tests and screen this delivery must satisfy. Criteria are recorded with your next message, before the agent runs. Empty filter means all tests in the path; screen definition is optional JSON.',
            'evidence.record_next' => 'Record these criteria with my next message',
            'evidence.test_path' => 'Test path',
            'evidence.test_filter' => 'Test filter (optional)',
            'evidence.screen_name' => 'Screen name',
            'evidence.screen_type' => 'Screen type',
            'evidence.screen_definition' => 'Screen definition (optional JSON)',
            'evidence.all_tests' => 'All tests in this path',
            'evidence.criteria_fixed' => 'These criteria are recorded for this session and cannot be changed.',
            'evidence.candidate' => 'Available candidate',
            'evidence.select_next' => 'Use this candidate with my next message',
            'evidence.selection_help' => 'Sending the next message binds this candidate to the recorded criteria. This does not approve or activate the screen.',
            'evidence.selected' => 'Selected candidate:',
            ...
            'evidence.current_evidence' => 'Ready for human review',
            'evidence.historical_evidence' => 'Evidence is out of date',
            'evidence.failed' => 'Tests failed',
            'evidence.indeterminate' => 'Evidence is unavailable',
            'evidence.incomplete' => 'Evidence is incomplete',
            'evidence.scope_missing' => 'No delivery scope has been declared for this session.',
            'evidence.truncated' => 'The explanation was cut short. The evidence can still be read.',
            'evidence.artifact' => 'Artifact',
            'evidence.tests' => 'Tests',
            'evidence.failures' => 'Failures',
            'evidence.errors' => 'Errors',
            'evidence.ran' => 'Tests ran',
            'evidence.coverage' => 'Requested scope covered',
            'evidence.approval' => 'Human approval',
            'evidence.not_recorded' => 'Not recorded',
            'evidence.unknown' => 'Unknown',
            'evidence.yes' => 'Yes',
            'evidence.no' => 'No',
            'evidence.review' => 'Review this revision',
            'evidence.reload' => 'Reload the page to read the current evidence.',
            'evidence.unavailable' => 'Delivery evidence is not available in this app.',
            'evidence.read_failed' => 'Evidence could not be read. Reload to try again.',
            'chip.gate' => 'gate: %s',
        ...
        'es' => [
            ...
            'evidence.criteria' => 'Criterios de entrega registrados',
            'evidence.set_criteria' => 'Definir criterios de entrega',
            'evidence.criteria_help' => 'Elige las pruebas y la pantalla que esta entrega debe satisfacer. Los criterios se registran con tu siguiente mensaje, antes de ejecutar al agente. Un filtro vacío incluye todas las pruebas de la ruta; la definición de pantalla es JSON opcional.',
            'evidence.record_next' => 'Registrar estos criterios con mi siguiente mensaje',
            'evidence.test_path' => 'Ruta de pruebas',
            'evidence.test_filter' => 'Filtro de pruebas (opcional)',
            'evidence.screen_name' => 'Nombre de pantalla',
            'evidence.screen_type' => 'Tipo de pantalla',
            'evidence.screen_definition' => 'Definición de pantalla (JSON opcional)',
            'evidence.all_tests' => 'Todas las pruebas de esta ruta',
            'evidence.criteria_fixed' => 'Estos criterios están registrados para la sesión y no se pueden cambiar.',
            'evidence.candidate' => 'Candidato disponible',
            'evidence.select_next' => 'Usar este candidato con mi siguiente mensaje',
            'evidence.selection_help' => 'Al enviar el siguiente mensaje, este candidato se enlaza a los criterios registrados. Esto no aprueba ni activa la pantalla.',
            'evidence.selected' => 'Candidato seleccionado:',
            'evidence.invalid_criteria' => 'Escribe una ruta de pruebas, un nombre y un tipo de pantalla.',
            'evidence.invalid_definition' => 'La definición de pantalla debe ser un objeto JSON.',
            'evidence.refresh_failed' => 'No se pudo actualizar la evidencia de entrega. Recarga la página antes de enviar otro mensaje.',
            'evidence.title' => 'Evidencia de la entrega',
            'evidence.current_evidence' => 'Lista para revisión humana',
            'evidence.historical_evidence' => 'La evidencia ya no está vigente',
            'evidence.failed' => 'Las pruebas fallaron',
            'evidence.indeterminate' => 'La evidencia no está disponible',
            'evidence.incomplete' => 'La evidencia está incompleta',
            'evidence.scope_missing' => 'Esta sesión no tiene un alcance de entrega declarado.',
            'evidence.truncated' => 'La explicación quedó cortada. Todavía puedes consultar la evidencia.',
            'evidence.artifact' => 'Artefacto',
            'evidence.tests' => 'Pruebas',
            'evidence.failures' => 'Fallos',
            'evidence.errors' => 'Errores',
            'evidence.ran' => 'Pruebas ejecutadas',
            'evidence.coverage' => 'Alcance solicitado cubierto',
            'evidence.approval' => 'Aprobación humana',
            'evidence.not_recorded' => 'No registrada',
            'evidence.unknown' => 'Desconocido',
            'evidence.yes' => 'Sí',
            'evidence.no' => 'No',
            'evidence.review' => 'Revisar esta revisión',
            'evidence.reload' => 'Recarga la página para consultar la evidencia vigente.',
            'evidence.unavailable' => 'La evidencia de entrega no está disponible en esta app.',
            'evidence.read_failed' => 'No se pudo leer la evidencia. Recarga para volver a intentar.',
            'chip.gate' => 'puerta: %s',
            'gate.kind.loopback' => 'loopback',
