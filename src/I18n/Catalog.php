...
final class Catalog
{
    ...
    private const MESSAGES = [
        'en' => [
            ...
            'settings.model.endpoint.unjudgeable' => 'This app cannot accept an endpoint yet: nothing here can say who may reconfigure the agent. Where the agent talks is where every prompt goes, so the field is not offered rather than failing when you press save.',
            'settings.model.endpoint.unjudgeable_command' => 'coa capabilities:enable milpa/auth --sign',
            ...
            'settings.model.key.unjudgeable' => 'This app cannot accept a key yet: nothing here can say who may write one. Identity is what a credential is gated by, so the field is not offered rather than failing when you press save.',
            'settings.model.key.unjudgeable_command' => 'coa capabilities:enable milpa/auth --sign',
        ...
        'es' => [
            ...
            'settings.model.endpoint.unjudgeable' => 'Esta app todavía no puede aceptar un endpoint: nada aquí puede decir quién puede reconfigurar al agente. A donde habla el agente es a donde va cada prompt, así que el campo no se ofrece en vez de fallar cuando le des guardar.',
            'settings.model.endpoint.unjudgeable_command' => 'coa capabilities:enable milpa/auth --sign',
            'settings.model.key' => 'API key',
            ...
            'settings.model.key.unjudgeable' => 'Esta app todavía no puede aceptar una llave: nada aquí puede decir quién tiene permiso de escribirla. Una credencial se protege con identidad, así que el campo no se ofrece en vez de fallar cuando le des guardar.',
            'settings.model.key.unjudgeable_command' => 'coa capabilities:enable milpa/auth --sign',
